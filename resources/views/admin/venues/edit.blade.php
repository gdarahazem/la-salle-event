        ...
        <div class="card-body">
            <form action="{{ route("admin.venues.update", [$venue->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="name" name="name" class="form-control"
                           value="{{ old('name', isset($venue) ? $venue->name : '') }}" required>
                    @if($errors->has('name'))
                        <p class="help-block">
                            {{ $errors->first('name') }}
                        </p>
                ...
                <div class="form-group {{ $errors->has('event_date') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="event_date" name="event_date" class="form-control"
                           value="{{ old('event_date', isset($venue) ? $venue->event_date : '') }}" required>
            ...
            {{ $errors->first('event_date') }}
                ...
                <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                    ...
                    @endif
                    <p class="helper-block">
                        Please enter the price for the event.
                    </p>
                </div>
                ...
                <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="address" name="address" class="form-control"
                           value="{{ old('address', isset($venue) ? $venue->address : '') }}" required>
                ...
                <div class="form-group {{ $errors->has('latitude') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="latitude" name="latitude" class="form-control"
                           value="{{ old('latitude', isset($venue) ? $venue->latitude : '') }}" required>
                ...
                <div class="form-group {{ $errors->has('longitude') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="longitude" name="longitude" class="form-control"
                           value="{{ old('longitude', isset($venue) ? $venue->longitude : '') }}" required>
                ...
                <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                    ...
                    <textarea id="description" name="description"
                              class="form-control ">{{ old('description', isset($venue) ? $venue->description : '') }}</textarea>
